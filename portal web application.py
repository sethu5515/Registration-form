...
class Login:
   ...
   def loginform(self):
      ...
      self.img=ImageTk.PhotoImage(file="3168064.webp")

      img=Label(Frame_login,image=self.img).place(x=0,y=0,width=800,height=700)
   ...
   def login(self):
      ...
      if self.email_txt.get()=="" or self.password.get()=="":
         ...
         try:
            ...
            con=pymysql.connect(host="localhost",user="root",password="Sethu5515@",
   ...
   def Register(self):
      ...
      Frame_login1.place(x=0,y=0,height=700,width=800)

      

      self.img=ImageTk.PhotoImage(file="3168064.webp")

      img=Label(Frame_login1,image=self.img).place(x=0,y=0,width=800,height=700)

      

      frame_input2=Frame(self.root,bg='white')

      frame_input2.place(x=80,y=130,height=450,width=630)
      ...
      label5=Label(frame_input2,text="conform Password",
   ...
   def appscreen(self):
        Frame_login=Frame(self.root,bg="white")
        #Frame_login.title("Duplicate value")
        Frame_login.place(x=0,y=0,height=700,width=800)
        self.img=ImageTk.PhotoImage(file="3168064.webp")
